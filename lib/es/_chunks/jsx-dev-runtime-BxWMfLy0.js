...
var M = {}, Ae;
function Sr() {
    return Ae || (Ae = 1, Ye.env.NODE_ENV !== "production" && (() => {
        ...
        function mr(e, r, t, n, u, s) {
            {
                ...
                if (D.call(r, "key")) {
                    var w = m(e), h = Object.keys(r).filter((Er) => Er !== "key"), ee = h.length > 0 ? "{key: someKey, " + h.join(": ..., ") + ": ...}" : "{key: someKey}";
                    if (!De[w + ee]) {
